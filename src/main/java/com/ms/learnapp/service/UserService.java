...
import com.ms.learnapp.config.Constants;
import com.ms.learnapp.domain.Authority;
import com.ms.learnapp.domain.User;
import com.ms.learnapp.repository.AuthorityRepository;
import com.ms.learnapp.repository.UserRepository;
import com.ms.learnapp.security.AuthoritiesConstants;
import com.ms.learnapp.security.SecurityUtils;
import com.ms.learnapp.service.dto.UserDTO;
...
public class UserService {
    ...
    public void updateUser(String firstName, String lastName, String email, String langKey, String imageUrl, 
            List<String> interestedInSkills, List<String> expertInSkills) {
        SecurityUtils.getCurrentUserLogin()
            ...
            .ifPresent(user -> {
                ...
                user.setInterestedInSkills(interestedInSkills);
                user.setExpertInSkills(expertInSkills);
                userRepository.save(user);
                this.clearUserCaches(user);
    ...
    public Optional<UserDTO> updateUser(UserDTO userDTO) {
        return Optional.of(userRepository
            ...
            .map(user -> {
                ...
                user.setExpertInSkills(userDTO.getExpertInSkills());
                user.setInterestedInSkills(userDTO.getInterestedInSkills());
                user.setLangKey(userDTO.getLangKey());
