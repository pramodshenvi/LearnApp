...
import { UserPointsComponent } from 'app/entities/user-points/user-points.component';
import { UserPointsService } from 'app/entities/user-points/user-points.service';
import { UserPoints } from 'app/shared/model/user-points.model';
...
describe('Component Tests', () => {
  describe('UserPoints Management Component', () => {
    ...
    beforeEach(() => {
      ...
      service = fixture.debugElement.injector.get(UserPointsService);
    });
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userPoints && comp.userPoints[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
